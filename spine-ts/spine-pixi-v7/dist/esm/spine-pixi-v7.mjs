...
import { Texture as Texture3 } from "@pixi/core";
var SlotMesh = class _SlotMesh extends Mesh {
  name = "";
  ...
  constructor() {
    ...
    const meshMaterial = new MeshMaterial(Texture3.EMPTY);
...
var DarkTintGeometry = class extends Geometry {
  ...
  constructor(_static = false) {
    super();
    const verticesBuffer = new Buffer(void 0);
    const uvsBuffer = new Buffer(void 0, true);
    const indexBuffer = new Buffer(void 0, true, true);
...
import { Shader, TextureMatrix, Color as Color3, Texture as Texture4, Matrix, Program } from "@pixi/core";
var vertex = `
...
`;
var DarkTintMaterial = class extends Shader {
  uvMatrix;
  batchable;
  pluginName;
  ...
  constructor(texture) {
    const uniforms = {
      uSampler: texture ?? Texture4.EMPTY,
      alpha: 1,
    ...
    this._tintColor = new Color3(options.tint);
    this._darkTintColor = new Color3(options.darkTint);
  ...
  update() {
    if (this._colorDirty) {
      this._colorDirty = false;
      Color3.shared.setValue(this._tintColor).premultiply(this._alpha, true).toArray(this.uniforms.uColor);
      Color3.shared.setValue(this._darkTintColor).premultiply(this._alpha, true).premultiply(1, false).toArray(this.uniforms.uDarkColor);
    }
...
// spine-pixi-v7/src/darkTintMesh/DarkTintMesh.ts
var DarkTintMesh = class extends Mesh2 {
  // eslint-disable-next-line @typescript-eslint/naming-convention
  _darkTintRGB = 0;
  constructor(texture) {
...
var Spine = class _Spine extends Container {
  ...
  */
  ...
  internalUpdate(_deltaFrame, deltaSeconds) {
    ...
    const delta = deltaSeconds ?? Ticker.shared.deltaMS / 1e3;
...
import { Container as Container2 } from "@pixi/display";
import { Graphics as Graphics2 } from "@pixi/graphics";
...
import { Assets as Assets2, copySearchParams } from "@pixi/assets";
...
var spineTextureAtlasLoader = {
  ...
  loader: {
    ...
    async parse(asset, options, loader) {
      ...
      Assets2.setPreferences({ preferCreateImageBitmap: false });
      ...
      Assets2.setPreferences({ preferCreateImageBitmap: oldPreferCreateImageBitmap });
      return retval;
    }
  }
};
...
import { LoaderParserPriority as LoaderParserPriority2, checkExtension as checkExtension2 } from "@pixi/assets";
import { ExtensionType as ExtensionType2, settings as settings2, extensions as extensions2 } from "@pixi/core";
...
var spineLoaderExtension = {
  ...
  loader: {
    ...
    async load(url) {
      const response = await settings2.ADAPTER.fetch(url);
...
import { Geometry as Geometry2, Buffer as Buffer2, TYPES as TYPES2 } from "@pixi/core";
var DarkTintBatchGeometry = class extends Geometry2 {
  // eslint-disable-next-line @typescript-eslint/naming-convention
  _buffer;
  // eslint-disable-next-line @typescript-eslint/naming-convention
  _indexBuffer;
  ...
  constructor(_static = false) {
    super();
    this._buffer = new Buffer2(void 0, _static, false);
    this._indexBuffer = new Buffer2(void 0, _static, true);
    this.addAttribute("aVertexPosition", this._buffer, 2, false, TYPES2.FLOAT).addAttribute("aTextureCoord", this._buffer, 2, false, TYPES2.FLOAT).addAttribute("aColor", this._buffer, 4, true, TYPES2.UNSIGNED_BYTE).addAttribute("aDarkColor", this._buffer, 4, true, TYPES2.UNSIGNED_BYTE).addAttribute("aTextureId", this._buffer, 1, true, TYPES2.FLOAT).addIndex(this._indexBuffer);
  }
};

// spine-pixi-v7/src/darkTintMesh/DarkTintRenderer.ts
import { extensions as extensions3, BatchRenderer, ExtensionType as ExtensionType3, BatchShaderGenerator, Color as Color4 } from "@pixi/core";
var vertex2 = `
...
`;
var DarkTintRenderer = class extends BatchRenderer {
  static extension = {
    name: "darkTintBatch",
    type: ExtensionType3.RendererPlugin
  };
  ...
  packInterleavedGeometry(element, attributeBuffer, indexBuffer, aIndex, iIndex) {
    ...
    const argb = Color4.shared.setValue(element._tintRGB).toPremultiplied(worldAlpha, true);
    const darkargb = Color4.shared.setValue(element._darkTintRGB).premultiply(worldAlpha, true).toPremultiplied(1, false);
...
extensions3.add(DarkTintRenderer);
export {
...
//# sourceMappingURL=spine-pixi-v7.mjs.map
